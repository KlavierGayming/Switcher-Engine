...
class GameJoltLogin extends MusicBeatSubstate
{
    ...
    override function create()
    {
        ...
        gamejoltText.font = Paths.font('vcr.ttf');
        add(gamejoltText);
    ...
    override function update(elapsed:Float)
    {
        ...
        {
            if (touch.overlaps(usernameBox) && touch.justReleased && !FlxG.stage.window.textInputEnabled)
                FlxG.stage.window.textInputEnabled = true;
            else if (touch.overlaps(tokenBox) && touch.justReleased && !FlxG.stage.window.textInputEnabled)
                FlxG.stage.window.textInputEnabled = true;
        }
