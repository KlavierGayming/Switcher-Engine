	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				case 'gf-neoremix':
					// GIRLFRIEND CODE
					tex = Paths.getSparrowAtlas('neo/GF_assets','shared');
					frames = tex;
					animation.addByPrefix('cheer', 'GF Cheer', 24, false);
					animation.addByPrefix('singLEFT', 'GF left note', 24, false);
					animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gfSunset':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('sunset/GF_assets','hex');
				frames = tex;
			    animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gfGlitcher':
				...
				case 'picoSpinny':
					// GIRLFRIEND CODE
					tex = Paths.getSparrowAtlas('picoSpeaker','week7');
					frames = tex;
					animation.addByPrefix('cheer', 'GF Cheer', 24, false);
					animation.addByPrefix('singLEFT', 'GF left note', 24, false);
					animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
					...
					playAnim('danceRight');
			case 'gf-tankman':
				tex = Paths.getSparrowAtlas('gfTankman','week7');
				frames = tex;
			...
			case 'gfNeo':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('gfNeo','shared');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'dad':
				...
				case 'dad-neoremix':
					// DAD ANIMATION LOADING CODE
					tex = Paths.getSparrowAtlas('neo/DADDY_DEAREST','shared');
					frames = tex;
					animation.addByPrefix('idle', 'Dad idle dance', 24);
					animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
					animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
			...
			case 'hex':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('hex','hex');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
				...
				case 'hex-sunset':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('sunset/DADDY_DEAREST','hex');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
			...
			case 'hex-night':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('night/hex-night','hex');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
			...
			case 'hexVirus':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('glitcher/Hex_Virus','hex');
				frames = tex;
			...
			case 'hexWire':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('WIRE/Hex_Virus','hex');
				frames = tex;
				animation.addByPrefix('idle', 'Hex crazy idle', 24);
				animation.addByPrefix('singUP', 'Hex crazy up', 24);
				animation.addByPrefix('singRIGHT', 'Hex crazy right', 24);
				...
				case 'tankman':
					// ARSE ANIMATION LOADING CODE
					tex = Paths.getSparrowAtlas('tankmanCaptain','week7');
					frames = tex;
					animation.addByPrefix('idle', 'Tankman Idle Dance instance 1', 24);
					animation.addByPrefix('singUP', 'Tankman UP note instance 1', 24);
					animation.addByPrefix('oldSingUP', 'Tankman UP note instance 1', 24);
					...
					animation.addByPrefix('good', 'PRETTY GOOD tankman instance 1', 24);
					animation.addByPrefix('ughAnim', 'TANKMAN UGH instance 1', 24);
			...
			case 'spooky':
				...
				case 'spooky-neoremix':
					tex = Paths.getSparrowAtlas('neo/spooky_kids_assets','shared');
					frames = tex;
					animation.addByPrefix('singUP', 'spooky UP NOTE', 24, false);
					animation.addByPrefix('singDOWN', 'spooky DOWN note', 24, false);
					animation.addByPrefix('singLEFT', 'note sing left', 24, false);
			...
			case 'mom-car-neoremix':
				tex = Paths.getSparrowAtlas('neo/momCar','shared');
				frames = tex;
			...
			case 'pico':
				...
				case 'pico-neoremix':
					tex = Paths.getSparrowAtlas('neo/Pico_FNF_assetss','shared');
					frames = tex;
					animation.addByPrefix('idle', "Pico Idle Dance", 24);
					animation.addByPrefix('singUP', 'pico Up note0', 24, false);
					animation.addByPrefix('singDOWN', 'Pico Down Note0', 24, false);
			...
			case 'picoNeo':
				tex = Paths.getSparrowAtlas('picoNeo','shared');
				frames = tex;
				animation.addByPrefix('idle', "Pico Idle Dance", 24);
				animation.addByPrefix('singUP', 'pico Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Pico Down Note0', 24, false);
			...
			case 'bfNeo':
				var tex = Paths.getSparrowAtlas('bfNeo', 'shared');
				frames = tex;
			...
			case 'bf':
				...
				case 'jamey':
					var tex = Paths.getSparrowAtlas('bf/JAMEY','shared');
					frames = tex;
					animation.addByPrefix('idle', 'BF idle dance', 24, false);
					animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
					animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
					...
					flipX = true;
					case 'mark':
						var tex = Paths.getSparrowAtlas('bf/MARK','shared');
						frames = tex;
						animation.addByPrefix('idle', 'BF idle dance', 24, false);
						animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
						animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
						...
						flipX = true;
						case 'custom':
							var tex = Paths.getSparrowAtlas('bf/custom','shared');
							frames = tex;
							animation.addByPrefix('idle', 'BF idle dance', 24, false);
							animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
							animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
							...
							flipX = true;
				case 'bf-neoremix':
					var tex = Paths.getSparrowAtlas('neo/BOYFRIEND','shared');
					frames = tex;
					animation.addByPrefix('idle', 'BF idle dance', 24, false);
					animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
					animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bfSunset':
				var tex = Paths.getSparrowAtlas('sunset/BOYFRIEND','hex');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				case 'bfNight':
					var tex = Paths.getSparrowAtlas('night/bf-night','hex');
					frames = tex;
					animation.addByPrefix('idle', 'BF idle dance', 24, false);
					animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
					animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
					...
					flipX = true;
					case 'bfGlitcher':
						var tex = Paths.getSparrowAtlas('glitcher/bf-glitcher','hex');
						frames = tex;
						animation.addByPrefix('idle', 'BF idle dance', 24, false);
						animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
						animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
						...
						flipX = true;
						case 'bfWire':
							var tex = Paths.getSparrowAtlas('WIRE/BOYFRIEND','hex');
							frames = tex;
							animation.addByPrefix('idle', 'BF idle dance', 24, false);
							animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
							animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bf-holding-gf':
				var tex = Paths.getSparrowAtlas('bfAndGF','week7');
				frames = tex;
			...
			case 'bf-holding-gf-dead':
				frames = Paths.getSparrowAtlas('bfHoldingGF-DEAD','week7');
